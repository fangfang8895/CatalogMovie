...
public class FavoriteWidget extends AppWidgetProvider {
    public static final String TOAST_ACTION = "com.yulia.dicoding.cataloguemoviesecond.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.yulia.dicoding.cataloguemoviesecond.EXTRA_ITEM";
